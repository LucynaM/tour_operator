...
from .views import AddTour, AddParticipant, EditTour, EditParticipant, ChangeStatus, generate_pdf,  generate_xls, FillParticipant, DeleteItem
...
urlpatterns = [
    ...
    url(r'^generate_xls/(?P<pk>(\d)+)/$', generate_xls, name='generate_xls'),
