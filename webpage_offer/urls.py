...
from .views import AddListOffer, EditOffer, ShowOffer, SelectOffer, SetSelected, SetRecommended, AddHoliday, EditHoliday
...
urlpatterns = [
    ...
    url(r'^add_holiday/$', AddHoliday.as_view(), name='add_holiday'),
